...
短视频详情页的二级评论和帖子详情的二级评论（APP）

姓氏库增加搜索功能；市场业绩界面把“下级”改成“部门”；创建族谱、修改族谱时，堂号非填写；加好友增加一个等待提示‘等待好友验证’，删除家谱增加一个说明‘ 已经被激活成员的家谱不允许删除’，在家谱简介那里增加一个激活人数；

去掉族谱信息界面的寻谱其他按钮；谱图缩放；消息聊天选择表情后显示在输入框内；自媒体管理改动：去掉浏览数，‘历史’改‘作品’，对接接口改动；新好友申请增加已读接口；

修复热门话题详情界面的时间显示问题；增加短视频详情功能；
## 明日
APP3.0线上问题修复
