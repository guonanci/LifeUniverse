...
# 日报
## 今日
和广睿一起调研fg-tree树状列表插件：https://ext.dcloud.net.cn/plugin?id=22784，因其滑动性能更好，操作更方便，可同时支持360度方向滑动，计划后续替换掉我们已有的组件。

通过‘hello uni-app’加深了解canvas/cover-view等组件的使用

在飞书上新建内部分享的文档《产品使用及自身定位、和路线规划的一些思考》，大致是对比百家有谱和我们公司，以及跟多端使用的产品服务、后续的开发规划和公司新能力相关。
