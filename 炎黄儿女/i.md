...
验证、测试线上的消息界面顶部菜单栏样式问题；验证、测试线上的‘我的-编辑资料’添加学历后不显示的问题；验证、测试线上的编辑家谱成员信息，并审核的功能；验证、测试线上的‘我的-朋友圈’菜单入口；阅读学习uni-app 推送消息的文档

修复编辑家谱人员资料时的安息地不显示的问题；

APP端测试：家谱列表页、个人传记；解决编写个人传记界面取消按钮没反应的问题；修复个人传记章节目录界面的样式；修复‘寻谱-族谱信息’界面的封面点击问题；
## 明日
APP3.0线上问题修复和需求开发；APP端测试和修复
